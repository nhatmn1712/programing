...
def register():     #Feature 4
    """Register personal information for new customers"""
    print('Press "0" to escape. Press "1" after registration to continue'
    go_register = 1
    while(go_register != 0):
        ...
        go_register = int(input("Do you want to continue registering?"))
